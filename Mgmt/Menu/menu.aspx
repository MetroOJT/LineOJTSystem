<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Menu.aspx.vb" Inherits="Sample_hirashima_menu" %>
...
<body>
    ...
    <div>
        <div id="Header" class="row">
            ...
            <div class="col-6"><input type="button" value="ログアウト" name="LogOut" class="col-6" id="LogOut" /></div>
            <div class="w-100"></div>
            <div class="col-6"></div>
