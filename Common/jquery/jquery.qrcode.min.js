(function (r) {
    r.fn.qrcode = function (h) {
        ...
        return a << 12 | c
            ...
            switch (a) {
            case 0: return 0 == (c + d) % 2;
            case 1: return 0 == c % 2;
            case 2: return 0 == d % 3;
            case 3: return 0 == (c + d) % 3;
            case 4: return 0 == (Math.floor(c / 2) + Math.floor(d / 3)) % 2;
            case 5: return 0 == c * d % 2 + c * d % 3;
            case 6: return 0 == (c * d % 2 + c * d % 3) % 2;
            case 7: return 0 == (c * d % 3 + (c + d) % 2) % 2;
            default: throw Error("bad maskPattern:" + a);
        }
        ...
        p.getRsBlockTable = function (a, c) {
            switch (c) {
                case 1: return p.RS_BLOCK_TABLE[4 * (a - 1) + 0];
                case 0: return p.RS_BLOCK_TABLE[4 * (a - 1) + 1];
                case 3: return p.RS_BLOCK_TABLE[4 * (a - 1) + 2];
                case 2: return p.RS_BLOCK_TABLE[4 * (a - 1) + 3]
            }
        };
        t.prototype = {
            get: function (a) {
        ...
        h = r.extend({}, { render: "canvas", width: document.getElementById("QRSize_Width").value, height: document.getElementById("QRSize_Height").value, typeNumber: -1, correctLevel: 1, background: "#ffffff", foreground: "#000000" }, h);
